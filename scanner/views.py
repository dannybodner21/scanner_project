...
def predict_live_vertex_new(request):
    ...
    for metric in metrics:
        instance = {
            "price": metric.price,
            "high_24h": metric.high_24h,
            "low_24h": metric.low_24h,
            "open": metric.open,
            "close": metric.close,
            "change_5m": metric.change_5m,
            "change_1h": metric.change_1h,
            "change_24h": metric.change_24h,
            "volume": metric.volume,
            "avg_volume_1h": metric.avg_volume_1h,
            "rsi": metric.rsi,
            "macd": metric.macd,
            "macd_signal": metric.macd_signal,
            "stochastic_k": metric.stochastic_k,
            "stochastic_d": metric.stochastic_d,
            "support_level": metric.support_level,
            "resistance_level": metric.resistance_level,
            "relative_volume": metric.relative_volume,
            "sma_5": metric.sma_5,
            "sma_20": metric.sma_20,
            "stddev_1h": metric.stddev_1h,
            "atr_1h": metric.atr_1h,
            "change_since_high": metric.change_since_high,
            "change_since_low": metric.change_since_low,
            "fib_distance_0_236": metric.fib_distance_0_236,
            "fib_distance_0_382": metric.fib_distance_0_382,
            "fib_distance_0_5": metric.fib_distance_0_5,
            "fib_distance_0_618": metric.fib_distance_0_618,
            "fib_distance_0_786": metric.fib_distance_0_786,
            "adx": metric.adx,
