...
def initial_setup_final():
    ...
    AXS = Coin.objects.get(symbol="AXS")
    coins_two.append(AXS)
    NOT = Coin.objects.get(symbol="NOT")
    coins_two.append(NOT)
    EIGEN = Coin.objects.get(symbol="EIGEN")
    coins_two.append(EIGEN)
    MNT = Coin.objects.get(symbol="MNT")
    coins_two.append(MNT)
    POL = Coin.objects.get(symbol="POL")
    coins_two.append(POL)
    CHZ = Coin.objects.get(symbol="CHZ")
    coins_two.append(CHZ)
    EGLD = Coin.objects.get(symbol="EGLD")
    coins_two.append(EGLD)
    PYTH = Coin.objects.get(symbol="PYTH")
    coins_two.append(PYTH)
    VIRTUAL = Coin.objects.get(symbol="VIRTUAL")
    coins_two.append(VIRTUAL)
    W = Coin.objects.get(symbol="W")
    coins_two.append(W)
    GRASS = Coin.objects.get(symbol="GRASS")
    coins_two.append(GRASS)
    KAIA = Coin.objects.get(symbol="KAIA")
    coins_two.append(KAIA)
    RUNE = Coin.objects.get(symbol="RUNE")
    coins_two.append(RUNE)
    MOCA = Coin.objects.get(symbol="MOCA")
    coins_two.append(MOCA)
    IO = Coin.objects.get(symbol="IO")
    coins_two.append(IO)
    FARTCOIN = Coin.objects.get(symbol="FARTCOIN")
    coins_two.append(FARTCOIN)
    JTO = Coin.objects.get(symbol="JTO")
    coins_two.append(JTO)
    POPCAT = Coin.objects.get(symbol="POPCAT")
    coins_two.append(POPCAT)
    BOME = Coin.objects.get(symbol="BOME")
    coins_two.append(BOME)
    MEW = Coin.objects.get(symbol="MEW")
    coins_two.append(MEW)
    GIGA = Coin.objects.get(symbol="GIGA")
    coins_two.append(GIGA)
    DYDX = Coin.objects.get(symbol="DYDX")
    coins_two.append(DYDX)
    LUNC = Coin.objects.get(symbol="LUNC")
    coins_two.append(LUNC)
    ETHFI = Coin.objects.get(symbol="ETHFI")
    coins_two.append(ETHFI)
    MORPHO = Coin.objects.get(symbol="MORPHO")
    coins_two.append(MORPHO)
    PENGU = Coin.objects.get(symbol="PENGU")
    coins_two.append(PENGU)
    PNUT = Coin.objects.get(symbol="PNUT")
    coins_two.append(PNUT)
    MOVE = Coin.objects.get(symbol="MOVE")
    coins_two.append(MOVE)
    ENA = Coin.objects.get(symbol="ENA")
    coins_two.append(ENA)
    BEAM = Coin.objects.get(symbol="BEAM")
    coins_two.append(BEAM)
    BRETT = Coin.objects.get(symbol="BRETT")
    coins_two.append(BRETT)
    SUSHI = Coin.objects.get(symbol="SUSHI")
    coins_two.append(SUSHI)
    ZRO = Coin.objects.get(symbol="ZRO")
    coins_two.append(ZRO)
    ATH = Coin.objects.get(symbol="ATH")
    coins_two.append(ATH)
    HBAR = Coin.objects.get(symbol="HBAR")
    coins_two.append(HBAR)
    SPX = Coin.objects.get(symbol="SPX")
    coins_two.append(SPX)
    AIXBT = Coin.objects.get(symbol="AIXBT")
    coins_two.append(AIXBT)
    FTM = Coin.objects.get(symbol="FTM")
    coins_two.append(FTM)

    GRT = Coin.objects.get(symbol="GRT")
    coins_two.append(GRT)

    MOG = Coin.objects.get(symbol="MOG")
    coins_two.append(MOG)
