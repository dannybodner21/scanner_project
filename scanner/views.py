...
def predict_live_vertex_new(request):
    ...
    for metric in metrics:
        instance = {
            "price": str(metric.price),
            "high_24h": str(metric.high_24h),
            "low_24h": str(metric.low_24h),
            "open": str(metric.open),
            "close": str(metric.close),
            "change_5m": str(metric.change_5m),
            "change_1h": str(metric.change_1h),
            "change_24h": str(metric.change_24h),
            "volume": str(metric.volume),
            "avg_volume_1h": str(metric.avg_volume_1h),
            "rsi": str(metric.rsi),
            "macd": str(metric.macd),
            "macd_signal": str(metric.macd_signal),
            "stochastic_k": str(metric.stochastic_k),
            "stochastic_d": str(metric.stochastic_d),
            "support_level": str(metric.support_level),
            "resistance_level": str(metric.resistance_level),
            "relative_volume": str(metric.relative_volume),
            "sma_5": str(metric.sma_5),
            "sma_20": str(metric.sma_20),
            "stddev_1h": str(metric.stddev_1h),
            "atr_1h": str(metric.atr_1h),
            "change_since_high": str(metric.change_since_high),
            "change_since_low": str(metric.change_since_low),
            "fib_distance_0_236": str(metric.fib_distance_0_236),
            "fib_distance_0_382": str(metric.fib_distance_0_382),
            "fib_distance_0_5": str(metric.fib_distance_0_5),
            "fib_distance_0_618": str(metric.fib_distance_0_618),
            "fib_distance_0_786": str(metric.fib_distance_0_786),
            "adx": str(metric.adx),
            "bollinger_upper": str(metric.bollinger_upper),
            "bollinger_middle": str(metric.bollinger_middle),
            "bollinger_lower": str(metric.bollinger_lower),
        }
