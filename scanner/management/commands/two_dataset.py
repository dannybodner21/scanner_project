...
class Command(BaseCommand):
    ...
    def handle(self, *args, **opts):
        ...
        # Save datasets
        train_csv = os.path.join(export_dir, "three_train_dataset.csv")
        test_csv = os.path.join(export_dir, "three_test_dataset.csv")
        preds_csv = os.path.join(export_dir, "three_predictions.csv")
        ...
        model_path = os.path.join(export_dir, "three_long_hgb_model.joblib")
        scaler_path = os.path.join(export_dir, "three_feature_scaler.joblib")
        features_path = os.path.join(export_dir, "three_feature_list.json")
        config_path = os.path.join(export_dir, "three_trade_config.json")
