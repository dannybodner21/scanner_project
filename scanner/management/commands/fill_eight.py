...
class Command(BaseCommand):
    help = 'Efficiently fill missing change_1h and change_24h for RickisMetrics (Apr 13–May 13) using CMC quotes.'
        ...
        for symbol in symbols:
            ...
            while current_day <= end_date:
                ...
                try:
                    ...
                    print(f"✅ {symbol} on {current_day.date()} — {updated} filled")
