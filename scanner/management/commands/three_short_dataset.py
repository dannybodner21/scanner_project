...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        TRAIN_FILE = 'short_three_training.csv'
        TEST_FILE = 'short_three_testing.csv'
        MODEL_FILE = 'short_three_model.joblib'
        SCALER_FILE = 'short_three_feature_scaler.joblib'
        FEATURES_FILE = 'short_three_selected_features.joblib'
        PREDICTION_FILE = 'short_three_enhanced_predictions.csv'
