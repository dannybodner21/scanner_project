...
import logging
from scanner.views import initial_setup_one, initial_setup_two, initial_setup_three, initial_setup_four, initial_setup_five, initial_setup_six, initial_setup_final, load_coins, fetch_short_interval_data, gather_daily_historical_data
