...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        while current_day <= end_time.date():
            ...
            self.stdout.write(f"Fetching full day {current_day} for {db_coin}...")
            ...
            try:
                ...
                for item in data:
                    ...
                    if ts not in existing_timestamps:
                        ...
                        existing_timestamps.add(ts)  # update set immediately
        ...
        self.stdout.write("🚀 Full strict backfill complete.")
    ...
    def fetch_single_candle(self, ts, coinapi_symbol, db_coin, headers, existing_timestamps):
        ...
        try:
            ...
            data = resp.json()
            if not data:
                self.stdout.write(f"⚠ No data returned for {ts_start}")
                return
