...
ALLOWED_HOSTS = ['crypto-scanner-cb7jr.ondigitalocean.app', 'localhost', '127.0.0.1', 'http://127.0.0.1']
...
STATIC_URL = "static/"
STATICFILES_DIRS = [BASE_DIR / "scanner_project/static"]  # For development
